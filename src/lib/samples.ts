/**
 * Sample manifests, so the tool demonstrates itself without depending on a live
 * origin still being up. Some are captures from public demo services; the
 * multi-period and SSAI ones are generated by scripts in this repository so
 * that no operator's stream is redistributed here.
 */
...
export interface Sample {
  ...
  capturedAt: string;
  liveUrl?: string;
  /** generated rather than captured from a live service, and labelled as such */
  synthetic?: boolean;
}
...
export const SAMPLES: Sample[] = [
  {
    ...
    note: "Live multi-period DASH where each avail is its own Period, with paired SCTE-35 start and end descriptors",
    entry: "manifest.mpd",
  ...
  },
  {
    ...
    note: "Live DASH carrying its avails as Events with explicit duration and auto_return, rather than as separate Periods",
    entry: "manifest.mpd",
    capturedAt: "2026-09-17",
    liveUrl: "https://demo.unified-streaming.com/k8s/live/scte35.isml/.mpd",
  },
  {
    id: "ssai-source",
